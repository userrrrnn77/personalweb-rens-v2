  ...
  return (
    <div className="flex flex-row relative items-center min-h-screen justify-center w-full h-full">
      ...
      <div className="flex flex-col items-center justify-center tranlate-y-[-50px] absolute z-[20] w-auto h-auto">
        <div className="flex flex-col items-center group cursor-pointer w-auto h-auto pb-3">
          <Image
            src="/LockTop.png"
            alt="locktop"
            width={50}
        ...
        <div className="Welcom-box px-[15px] py-[4px] z-[20] border border-[#7042f88b] opacity-[0.9]">
